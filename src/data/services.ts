...
export const services: Service[] = [
  ...
  },
  {
    ...
    tagline: 'Everything that is not a wedding.',
    priceFrom: 650,
    priceNote: 'depending on scale',
    bestFor: 'Proposals, bachelorettes, showers, birthdays',
    covers: ['first-call', 'design', 'suppliers', 'the-day'],
    includes: [
      'Proposals planned and quietly photographed',
      'Bachelorette weekends, start to finish',
      'Baby showers and christenings',
      'Milestone birthdays and anniversaries',
      'Styling, suppliers and on-the-day running',
    ],
    body: [
      'The same approach at a smaller scale. A proposal on a frozen lake, a bachelorette that people actually enjoy, a fortieth that is not a room with balloons in it.',
      'These are often how couples meet me before they ever mention a wedding.',
    ],
